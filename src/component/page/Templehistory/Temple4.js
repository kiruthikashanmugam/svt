...
import blog1 from "../../assets/img/blog/sm/1.jpg";
import blog2 from "../../assets/img/blog/sm/2.jpg";
import blog3 from "../../assets/img/blog/sm/3.jpg";
    ...
    <div className="sigma_footer-bottom">
      <div className="container-fluid">
        <div className="sigma_footer-copyright">
          <p> Copyright © Ndot <a  className="text-white">2023</a> </p>
        </div>
