...
const Category1 = () => {
    ...
    const getData = () => {
        axios
            .get(`https://svt.know3.com/api/donationcat/brick`, {})
            .then((response) => {
    ...
    const addToCart = (tdata, cartId) => {
        console.log("check value serive ", tdata)
    ...
    if (loading) {
        return (
            <div>
                <div style={{ width: '100%', textAlign: 'center', backgroundColor: "white", marginTop: '300px' }}>
...
export default connect(null, { actFetchProductsRequest, AddCart })(Category1);