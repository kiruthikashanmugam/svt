...
import { actFetchProductsRequest, AddCart, IncreaseQuantity, DecreaseQuantity, DeleteCart } from '../../Addtocart/Actions/cartActions';
...
function Calendarview({ AddCart, items, IncreaseQuantity, DecreaseQuantity, DeleteCart, props }) {
      ...
      <div>
        ...
        <Modal   {...props}
          ...
          <Modal.Footer>
            ...
            <a class="sigma_btn-custom secondary" style={{ padding: "10px" }} onClick={(e) => handleData(e, ListCart, TotalCart)} >Checkout</a>
...
export default connect(mapStateToProps, { actFetchProductsRequest, AddCart, IncreaseQuantity, DecreaseQuantity, DeleteCart })(Calendarview);
